...
# export OUT_FILENAME=e3_seal_batched_kernel.csv
...
#     g++ -std=c++17 -Wno-deprecated-declarations -I${E3}/src -I${E3}/3p/seal_unx/include main.cpp secint.cpp cgtshared.cpp -o bob.exe ${E3}/3p/seal_unx/native/libseal.a
...
echo "============================================================"
echo "==== Running hamming-tfhe =================================="
echo "============================================================"

export OUT_FILENAME=e3_tfhe_chi_squared.csv
export CGT_FILENAME=cgt_tfhe.cfg

cd $E3/eval/hamming-tfhe
echo "t_keygen,t_input_encryption,t_computation,t_decryption" > $OUT_FILENAME
...
echo "============================================================"
echo "==== Running auction-tfhe =================================="
echo "============================================================"

export OUT_FILENAME=e3_tfhe_chi_squared.csv
export CGT_FILENAME=cgt_tfhe.cfg

cd $E3/eval/auction-tfhe
echo "t_keygen,t_input_encryption,t_computation,t_decryption" > $OUT_FILENAME
...
echo "============================================================"
echo "==== Running kernel-tfhe ==================================="
echo "============================================================"

export OUT_FILENAME=e3_tfhe_kernel.csv
export CGT_FILENAME=cgt_tfhe.cfg
